...
class Changepassword  extends BaseController//extends CI_Controller
{
    ...
    function changepassword()
    {
        ...
        else
        {
            ...
            $samepassword = $this->Changepassword_model->samepasswordcheck($oldPassword,$newPassword);
            ...
            if($samepassword != FALSE) {
                ...
                $this->session->set_flashdata('sameasold', 'New password should not be same as Old password');
                redirect('changemypassword');
            }
