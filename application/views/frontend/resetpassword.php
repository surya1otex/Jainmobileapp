...
<input name="password" type="password" required="required" placeholder="new password">
<label>Confirm New Password</label>
<input name="conf_password" type="password" required="required" placeholder="confirm password">
</div>
