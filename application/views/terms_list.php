...
<!--                    <a class="btn btn-primary" href="<?php echo base_url(); ?>Termcondition/addNew"><i class="fa fa-plus"></i> Add New</a>-->
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                   ...
                   if(!empty($termsconditions))
                    {
                      foreach($termsconditions as $record)
                        {
                    ?>
                    <tr>
                         <td><?php echo $i ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'termcondition/editOld/'.$record->cms_id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
                            <a class="btn btn-sm btn-danger deletenotification" href="#" data-userid="<?php echo $record->cms_id; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                       $i++;  }
